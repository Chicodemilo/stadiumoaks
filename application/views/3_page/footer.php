        	...
        	<?php 
		        ...
		        if ($property_facebook != 'N') {
			        		...
			        		echo '<svg version="1.1" id="Layer_1" class="facebook_logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
								...
								<path fill="#DBDBDB" d="M148.492,0h-99C22.155,0,0,22.155,0,49.5v99C0,175.836,22.155,198,49.492,198h99
				...
				if ($property_twitter != 'N') {
					$property_twitter = prep_url($property_twitter);
							...
							echo '<svg version="1.1" id="Layer_1" class="twitter_logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
										 width="30px" height="30px" viewBox="0 0 198 198" enable-background="new 0 0 198 198" xml:space="preserve">
									<path fill="#DBDBDB" d="M148.574,0h-99C22.226,0,0,22.3,0,49.645v99C0,175.98,22.226,198,49.574,198h99
				...
				if ($property_instagram != 'N') {
					$property_instagram = prep_url($property_instagram);
							...
							echo '<svg version="1.1" id="Layer_1" class="instagram_logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
										 width="30px" height="30px" viewBox="0 0 198 198" enable-background="new 0 0 198 198" xml:space="preserve">
									<g>
										<polygon fill="#DBDBDB" points="146.549,72.349 146.549,54.107 146.549,51.377 143.818,51.394 125.577,51.447 125.652,72.418 	"/>
										<path fill="#DBDBDB" d="M132.838,99c0,18.657-15.181,33.838-33.838,33.838S65.163,117.657,65.163,99
										...
										<path fill="#DBDBDB" d="M99,120.775c12.004,0,21.784-9.771,21.784-21.775c0-4.735-1.547-9.12-4.125-12.697
										...
										<path fill="#DBDBDB" d="M148.5,0h-99C22.155,0,0,22.155,0,49.5v98.992C0,175.836,22.155,198,49.5,198h99
					...
					$property_google_plus = prep_url($property_google_plus);
							...
							echo '<svg version="1.1" id="Layer_1" class="google_logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
										 width="30px" height="30px" viewBox="0 0 198 198" enable-background="new 0 0 198 198" xml:space="preserve">
									<g>
										<path fill="#DBDBDB" d="M84.674,117.332c-0.718-0.487-1.456-0.994-2.223-1.519c-2.24-0.685-4.608-1.048-7.042-1.072l-0.297-0.009
										...
										<path fill="#DBDBDB" d="M148.5,0h-99C22.155,0,0,22.164,0,49.5v99C0,175.845,22.155,198,49.5,198h99
											...
											V96.442z"/>
										<path fill="#DBDBDB" d="M76.75,87.966c0.008,0,0.008,0,0.008,0c2.673,0,4.93-1.052,6.679-3.053
