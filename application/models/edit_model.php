...
class Edit_model extends CI_Model{
	...
	public function get_new_picture_data(){
		...
		if(count($ids)  > 49){
			...
			$data = array('id' => $id_new, 'name' => '', 'caption' => '','cover_pic' => 'N', 'logo' => 'N', 'management_logo' => 'N', 'amenities_page_main_pic' => 'N', 'picture_page_main_pic' => 'N', 'pic_order' => $order_new, 'active' => 'Y');
			return $data;
		}
	}
	...
	public function get_new_logo_data(){
		...
		$id_new = $ids[0]['id'] + 1;
		$order_new = null;
		$data = array('id' => $id_new, 'name' => '', 'caption' => '','cover_pic' => 'N', 'logo' => 'N', 'management_logo' => 'N', 'amenities_page_main_pic' => 'N', 'picture_page_main_pic' => 'N', 'pic_order' => $order_new, 'active' => 'Y', 'logo' => 'Y');
		return $data;
	}
	...
	public function get_new_man_logo_data(){
		...
		$id_new = $ids[0]['id'] + 1;
		$order_new = null;
		$data = array('id' => $id_new, 'name' => '', 'caption' => '','cover_pic' => 'N', 'logo' => 'N', 'management_logo' => 'Y', 'amenities_page_main_pic' => 'N', 'picture_page_main_pic' => 'N', 'pic_order' => $order_new, 'active' => 'Y');
		return $data;
	}
