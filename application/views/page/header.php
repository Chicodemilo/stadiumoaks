...
<head>
    ...
    <link rel='stylesheet' media='only screen and (min-width: 821px)' href='<?php echo base_url();?>css/apartment_view_main.css' />
    <link rel='stylesheet' media='only screen and (max-width: 820px)' href='<?php echo base_url();?>css/apartment_view_main_small.css' />
    <link rel='stylesheet' media='handheld' href='<?php echo base_url();?>css/apartment_view_main_small.css' />
